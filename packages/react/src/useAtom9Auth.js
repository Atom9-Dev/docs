...
export function useAtom9Auth({ issuer='https://id.atom9.com', tenantId, appSlug, callbackUrl, actorUserId='react-user', clientRole='admin' }) {
  return useMemo(() => {
  ...
  }, [issuer, tenantId, appSlug, callbackUrl, actorUserId, clientRole]);
}
